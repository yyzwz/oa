...
export const getNotImportUserData = (params) => {
    return getRequest('/postLevel/getNotImportUserData', params)
}
export const importUserByPostId = (params) => {
    return postRequest('/postLevel/importUserByPostId', params)
}
//by zwz
// ------------------------------分割线-----------------------------
// ------------------------------分割线-----------------------------
...
export const getUserByPostLevel = (params) => {
    return getRequest('/user/getUserByPostLevel', params)
}
export const getOneWelfare = (params) => {
    return getRequest('/welfare/getOne', params)
}
export const editWelfare = (params) => {
    return postRequest('/welfare/insertOrUpdate', params)
}
...
export const getAllJueSeMangerInTree = (params) => {
    return getRequest('/postLevel/getByAllSubInTreeByParentId/0', params)
}
// 获取一级角色
export const initJueSeManger = (params) => {
    return getRequest('/postLevel/getByParentId/0', params)
}
// 加载角色子级数据
export const loadJueSeManger = (id, params) => {
    return getRequest(`/postLevel/getByParentId/${id}`, params)
}
// 添加角色
export const addJueSeManger = (params) => {
    return postRequest('/postLevel/add', params)
}
// 编辑角色
export const editJueSeManger = (params) => {
    return postRequest('/postLevel/edit', params)
}
// 删除角色
export const deleteJueSeManger = (params) => {
    return postRequest('/postLevel/delByIds', params)
}
// 搜索角色
export const searchJueSeManger = (params) => {
    return getRequest('/postLevel/search', params)
}
// ============================================================
// 获取全部岗位
