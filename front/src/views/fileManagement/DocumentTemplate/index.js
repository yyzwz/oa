...
// ------------------------------分割线-----------------------------
// ------------------------------分割线-----------------------------
export const deleteFuJianMoBan = (params) => {
    return postRequest('/documentTemplate/delByIds', params)
}
export const addFuJianMoBan = (params) => {
    return postRequest('/documentTemplate/insertOrUpdate', params)
}
export const findAllHou = (params) => {
    return getRequest('/documentTemplate/findAllHou', params)
}
export const getFuJianAllData = (params) => {
    return getRequest('/documentTemplate/getByPage', params)
}
