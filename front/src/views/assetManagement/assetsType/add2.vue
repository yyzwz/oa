<template>
  <div>
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left" >          <FormItem label="资产名称" prop="assetName"  >
...
import { addAssetsType } from "./api2.js";
export default {
  name: "add",
  components: {
    },
  data() {
    return {
      ...
      formValidate: {
        ...
        unitPrice: [{ type: "number", required: true, message: "不能为空", trigger: "blur" }],
      }
    };
  },
  methods: {
