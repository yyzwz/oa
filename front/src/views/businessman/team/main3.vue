          ...
          <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
            ...
            <span v-if="drop">
              <FormItem label="电话" prop="mobile"  >
                <Input v-model="searchForm.mobile" clearable style="width:570px"/>
              </FormItem>
              ...
              <FormItem label="性别" prop="sex"  >
                ...
                <Select v-model="searchForm.sex" clearable style="width:570px">
                  <Option
              ...
              <FormItem label="学校" prop="school"  >
                <Input v-model="searchForm.school" clearable style="width:570px"/>
              </FormItem>
              <FormItem label="学历" prop="schoolLevel"  >
                <Input v-model="searchForm.schoolLevel" clearable style="width:570px"/>
              </FormItem>
              <FormItem label="专业" prop="major"  >
                <Input v-model="searchForm.major" clearable style="width:570px"/>
              </FormItem>
...
import { getSonCompanyList, deleteSonCompany } from "./api3.js";
// 根据你的实际添加编辑组件位置路径修改
import add from "./add3.vue";
import edit from "./edit3.vue";
export default {
  name: "single-window",
  components: {
    add,
  ...
  methods: {
    ...
    changeBirthday(e){
      ...
      this.searchForm.birthday = AgoTime.getFullYear() + '-' + (AgoTime.getMonth() + 1) + '-' + AgoTime.getDate();
    },
    submited() {
      this.currView = "index";
      this.getDataList();
