      ...
      <div :style="{maxHeight: maxHeight}" class="drawer-content">
        ...
        <Form ref="form" :model="form" :rules="formValidate" label-position="top">
          ...
          <Row :gutter="32">
            ...
            <Col span="12">
              ...
              <FormItem label="角色分配" prop="roleIds">
                ...
                <Select multiple v-model="form.roleIds" @on-change="changeRoles">
                  <Option
          ...
          <Row :gutter="32">
            <Col span="12">
              <FormItem label="主岗位">
                <postLevelChoose @on-change="handleSelectDep" ref="postLevelChoose"></postLevelChoose>
              </FormItem>
            </Col>
          </Row>
          <Row :gutter="32">
            <Col span="24">
              <FormItem label="预设权限">
                <Input type="textarea" v-model="form.permissionPreset" :rows="4" readonly/>
              </FormItem>
            </Col>
          </Row>
          <Divider />
...
import postLevelChoose from "@/views/my-components/xboot/post-level-choose.vue";
export default {
  name: "user",
  components: {
  ...
  methods: {
    ...
    changeRoles(e){
      ...
      // this.form.roleIdsTemp = ids.substring(0, ids.length - 1);
      // console.log("roleIdsTemp = " + this.form.roleIdsTemp);
    },
    getRoleList() {
    ...
    submit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          // this.form.roleIds = this.form.roleIdsTemp;
    ...
    setCurrentValue(value) {
      ...
      if (this.type == "0" || this.type == "1") {
        ...
        // 角色
        let selectRolesId = [];
        // console.log(data.newRoles);
        data.newRoles.forEach(function(e) {
          // console.log(e);
        ...
        // this.form.roleIds = ['496138616573953'];
        // console.log(this.form.roleIds);
      } else {
        // 添加
