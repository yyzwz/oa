    ...
    <Card v-show="currView=='index'">
        <Row @keydown.enter.native="handleSearch">
          <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
            ...
            <Form-item label="店面形象" prop="title">
              <Input type="text" v-model="searchForm.title" placeholder="请输入店面形象" clearable style="width: 200px"/>
            </Form-item>
            <span v-if="drop">
...
import { getSonCompanyList, deleteSonCompany } from "./api4.js";
// 根据你的实际添加编辑组件位置路径修改
import add from "./add4.vue";
import edit from "./edit4.vue";
export default {
  name: "single-window",
  components: {
    add,
