    ...
    <Card v-show="currView=='index'">
        <Row @keydown.enter.native="handleSearch">
          <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
            ...
            <Form-item label="通信位置" prop="title">
              <Input type="text" v-model="searchForm.title" placeholder="请输入通信位置" clearable style="width: 200px"/>
            </Form-item>
            <span v-if="drop">
...
import { getSonCompanyList, deleteSonCompany } from "./api2.js";
// 根据你的实际添加编辑组件位置路径修改
