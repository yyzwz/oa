    ...
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left" >        <FormItem label="工号" prop="userId"  >
        ...
        <FormItem label="年份" prop="year"  >
          <Select v-model="form.year" clearable style="width:570px" disabled>
            <Option
        ...
        <FormItem label="月份" prop="mouth"  >
          <Select v-model="form.mouth" clearable style="width:570px" disabled>
            <Option
...
import { editPunchClock } from "./api.js";
export default {
  name: "edit",
  components: {
    },
  ...
  methods: {
    ...
    handleSubmit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          editPunchClock(this.form).then(res => {
