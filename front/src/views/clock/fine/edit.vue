<template>
  <div>
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left" >        <FormItem label="被罚款人" prop="person"  >
          <Input v-model="form.person" clearable style="width:570px" placeholder="谁被罚款了呢?"/>
        </FormItem>
