    ...
    <Card v-show="currView=='index'">
        <Row @keydown.enter.native="handleSearch">
          <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
            ...
            <Form-item label="城市" prop="title">
              <Input type="text" v-model="searchForm.title" placeholder="请输入城市" clearable style="width: 200px"/>
            </Form-item>
            <span v-if="drop">
              <Form-item label="省份" prop="sheng">
                <Select v-model="searchForm.sheng" placeholder="请选择" clearable style="width: 200px">
                  <Option
...
import { getShiList, deleteShi,findAllSheng,findAllCityLevel,findAllCityType } from "./api.js";
// 根据你的实际添加编辑组件位置路径修改
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      this.loading = true;
        getShiList(this.searchForm).then(res => {
          this.loading = false;
          if (res.success) {
