    ...
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left" >        
        ...
        <FormItem label="区域" prop="city"  >
          <Select :placeholder="form.area" clearable style="width: 200px" @on-change="changeArea">
              <Option
          ...
          <FormItem label="销售范围" prop="sellThing"  >
            <Input v-model="form.sellThing" clearable style="width:570px"/>
          </FormItem>
...
import { editSellArea,getAllArea } from "./api.js";
export default {
  name: "edit",
  components: {
    },
  ...
  methods: {
    ...
    handleSubmit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          editSellArea(this.form).then(res => {
