    ...
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left" >          <FormItem label="编码" prop="number"  >
          ...
          <FormItem label="区域" prop="title"  >
            <Select v-model="form.title" placeholder="请选择" clearable style="width: 200px">
              <Option
          ...
          <FormItem label="省份" prop="sheng"  >
            <al-cascader level="0" @on-change="changeSheng" style="width: 200px" />
...
import { addSheng,getAllAreaList } from "./api.js";
export default {
  name: "add",
  components: {
    },
