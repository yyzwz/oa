    ...
    <Card v-show="currView=='index'">
        <Row @keydown.enter.native="handleSearch">
          <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
            <Form-item label="类别编码" prop="typeNumber">
              <Input type="text" v-model="searchForm.typeNumber" placeholder="请输入类别编码" clearable style="width: 200px"/>
            </Form-item>
            <Form-item label="客户类别" prop="manType">
              <Input type="text" v-model="searchForm.manType" placeholder="请输入客户类别" clearable style="width: 200px"/>
            </Form-item>
            <span v-if="drop">
