    ...
    <Card v-show="currView=='index'">
        <Row @keydown.enter.native="handleSearch">
          <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
            <Form-item label="资质代码" prop="ziNumber">
              <Input type="text" v-model="searchForm.ziNumber" placeholder="请输入资质代码" clearable style="width: 200px"/>
            </Form-item>
            <Form-item label="客户资质" prop="ziZhi">
              <Input type="text" v-model="searchForm.ziZhi" placeholder="请输入客户资质" clearable style="width: 200px"/>
            </Form-item>
            <span v-if="drop">
