    ...
    <Card v-show="currView=='index'">
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
          <Form ref="searchForm" :model="searchForm" inline :label-width="70">
              ...
              <Form-item label="学号" prop="number">
                <Input type="text" v-model="searchForm.number" placeholder="请输入学号" clearable style="width: 200px"/>
              </Form-item>
...
import { getStudentList, deleteStudent } from "./api.js";
// 根据你的实际添加编辑组件位置路径修改
  ...
  methods: {
    ...
    remove(v) {
      this.$Modal.confirm({
        ...
        onOk: () => {
          // 删除
            deleteStudent({ids: v.id}).then(res => {
              this.$Modal.remove();
              if (res.success) {
