...
export const isHaveMessage = (params) => {
    return getRequest('/newMessage/isHave', params)
}
export const getNewMessage = (params) => {
    return getRequest('/newMessage/getByPage', params)
}
export const deleteNewMessage = (params) => {
    return postRequest('/newMessage/delByIds', params)
}
...
export const getAllJueSeMangerInTree = (params) => {
    return getRequest('/jueSeManger/getByAllSubInTreeByParentId/0', params)
}
// 获取一级角色
export const initJueSeManger = (params) => {
    return getRequest('/jueSeManger/getByParentId/0', params)
}
// 加载角色子级数据
export const loadJueSeManger = (id, params) => {
    return getRequest(`/jueSeManger/getByParentId/${id}`, params)
}
// 添加角色
export const addJueSeManger = (params) => {
    return postRequest('/jueSeManger/add', params)
}
// ============================================================
// 获取全部岗位
export const getAllProfessionInTree = (params) => {
    return getRequest('/profession/getByAllSubInTreeByParentId/0', params)
}
// 获取一级岗位
export const initProfession = (params) => {
    return getRequest('/profession/getByParentId/0', params)
}
// 加载岗位子级数据
export const loadProfession = (id, params) => {
    return getRequest(`/profession/getByParentId/${id}`, params)
}
// 添加岗位
export const addProfession = (params) => {
    return postRequest('/profession/add', params)
}
// 编辑岗位
export const editProfession = (params) => {
    return postRequest('/profession/edit', params)
}
// 删除岗位
export const deleteProfession = (params) => {
    return postRequest('/profession/delByIds', params)
}
// 搜索岗位
export const searchProfession = (params) => {
    return getRequest('/profession/search', params)
}


// 获取全部部门
export const getAllDepartmentInTree = (params) => {
    return getRequest('/department/getByAllSubInTreeByParentId/0', params)
}
// 获取一级部门
...
export const initElseJueSe = (params) => {
    return getRequest('/elseJueSe/getByParentId/0', params)
}
export const loadElseJueSe = (id, params) => {
    return getRequest(`/elseJueSe/getByParentId/${id}`, params)
}
export const searchElseJueSe = (params) => {
    return getRequest('/elseJueSe/search', params)
}
export const getElseJueSeList = (params) => {
    return getRequest('/elseJueSe/getAllByPage', params)
}
export const getAllElseJueSeList = (params) => {
    return getRequest('/elseJueSe/getAllRoleGroupList', params)
}
export const getAllElseJueList = (params) => {
    return getRequest('/elseJueSe/getAllList', params)
}

export const initPermission = (params) => {
    return getRequest('/permission/getByParentId/0', params)
}
...
// 获取全部角色组
export const getAllRoleGroupInTree = (params) => {
    return getRequest('/roleGroup/getByAllSubInTreeByParentId/0', params)
}
// 获取一级角色组
export const initRoleGroup = (params) => {
    return getRequest('/roleGroup/getByParentId/0', params)
}
// 获取全部角色组数据
export const getAllRoleGroupList = (params) => {
    return getRequest('/roleGroup/getAllRoleGroupList', params)
}
// 加载角色组子级数据
export const loadRoleGroup = (id, params) => {
    return getRequest(`/roleGroup/getByParentId/${id}`, params)
}
// 添加角色组
export const addRoleGroup = (params) => {
    return postRequest('/roleGroup/add', params)
}
// 编辑角色组
export const editRoleGroup = (params) => {
    return postRequest('/roleGroup/edit', params)
}
// 删除角色组
export const deleteRoleGroup = (params) => {
    return postRequest('/roleGroup/delByIds', params)
}
// 搜索角色组
export const searchRoleGroup = (params) => {
    return getRequest('/roleGroup/search', params)
}
