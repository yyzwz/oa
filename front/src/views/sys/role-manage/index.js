...
export const findNotImportUserByRoleId = (params) => {
    return getRequest('/role/findNotImportUserByRoleId', params)
}
export const importUserByRoleId = (params) => {
    return postRequest('/role/importUserByRoleId', params)
}
// 角色组 API
// 获取全部角色组
export const getUserListData2 = (params) => {
    return getRequest('/user/getByCondition2', params)
}
...
//by zwz
//修改安保范围
export const editFanweiAPI = (params) => {
    return getRequest('/securityBaoAn/editFanwei', params)
}
export const importAnBaoByHua = (params) => {
    return postRequest('/securityBaoAn/importByIds', params)
}
// ------------------------------分割线-----------------------------
// ------------------------------分割线-----------------------------
// 安保管理api接口 
export const getSecurityData = (params) => {
    return getRequest('/securityBaoAn/getByPage', params)
}
export const deleteSecurityData = (params) => {
    return postRequest('/securityBaoAn/delByIds', params)
}
export const addSecurityData = (params) => {
    return postNoAuthRequest('/securityBaoAn/insertOrUpdate', params)
}
...
export const getHuaListData = (params) => {
    return getRequest('/role/getByPage', params)
}
export const getAllRoles = (params) => {
    return getRequest('/role/getAllRoles', params)
}
export const importHuaData = (params) => {
    return getRequest('/role/importJueSe', params)
}
