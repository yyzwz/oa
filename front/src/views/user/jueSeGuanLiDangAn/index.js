...
export const getAllJueSeMangerInTree = (params) => {
    return getRequest('/role/getByAllSubInTreeByParentId/0', params)
}
// 获取一级角色
export const initJueSeManger = (params) => {
    return getRequest('/role/getByParentId/0', params)
}
// 加载角色子级数据
export const loadJueSeManger = (id, params) => {
    return getRequest(`/role/getByParentId/${id}`, params)
}
// 添加角色
