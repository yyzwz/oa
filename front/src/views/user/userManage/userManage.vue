  ...
  <div class="search">
    <Card>
      ...
      <Row class="operation">
        ...
        <Button @click="openImportHuaWindows" type="primary" icon="md-add">导入花名册数据</Button>
    ...
    <importRoster v-model="showImportRoster" @on-submit="closeImportHuaWindows" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    remove(v) {
      this.$Modal.confirm({
        title: "确认删除用户 "+ v.username + " ?",
        content: "删除后,关联的部门,角色将会同步删除!",
        loading: true,
        onOk: () => {
