...
// 获取最新工号
export const getNewJobNumber = (params) => {
    return getRequest('/user/getNewJobNumber', params)
}
//by zwz
// ------------------------------分割线-----------------------------
// ------------------------------分割线-----------------------------
...
export const getBusiness = (params) => {
    return getRequest('/insurance/getBusiness', params)
}
export const getSociology = (params) => {
    return getRequest('/insurance/getSociology', params)
}
export const deleteRoster = (params) => {
    return postRequest('/roster/delByIds', params)
}
export const getIntroduce = (params) => {
    return getRequest('/roster/getIntroduce', params)
}
export const updateIntroduce = (params) => {
    return getRequest('/roster/updateIntroduce', params)
}
...
export const checkMobile = (params) => {
    return getRequest('/roster/checkMobile', params)
}
...
export const getOnePost = (params) => {
    return getRequest('/rosterPost/getOnePost', params)
}
export const setHuaGang = (params) => {
    return postRequest('/rosterPost/insertOrUpdate', params)
}
// 花名册api
// 批量导入全部钉钉数据到数据库
...
export const getOneHua = (params) => {
    return getRequest('/roster/get', params)
}
...
export const fu = (params) => {
    return postRequest('/roster/fu', params)
}
export const tui = (params) => {
    return postRequest('/roster/tui', params)
}
...
export const addHuaListData = (params) => {
    return postNoAuthRequest('/roster/insertOrUpdate', params)
}
export const savePermissionPreset = (params) => {
    return postRequest('/roster/savePermissionPreset', params)
}
...
export const getFuJianData = (params) => {
    return getRequest('/rosterEnclosure/getByPage', params)
}
export const addFuJian = (params) => {
    return postRequest('/rosterEnclosure/insertOrUpdate', params)
}
export const deleteFuJian = (params) => {
    return postRequest('/rosterEnclosure/delByIds', params)
}
// ------------------------------分割线-----------------------------
